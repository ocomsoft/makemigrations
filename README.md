...
> differently. For migrations generated by `makemigrations generate`
...
When a field removal, table drop, or rename is detected, makemigrations shows an interactive prompt before generating:

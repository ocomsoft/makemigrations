...
Enter
Type "../makemigrations generate --name \"create_users\""
Enter
Sleep 2s
...
Type "../makemigrations generate --name \"add_created_at\""
Enter
Sleep 2s
...
Type "../makemigrations generate --name \"add_email_index\""
Enter
Sleep 2s
...
Type "../makemigrations generate --name \"add_posts_table\""
Enter
Sleep 2s
...
Type "../makemigrations generate --name \"add_tags_m2m\""
Enter
Sleep 2s
...
Enter
Type "../makemigrations generate --dry-run --silent --name \"example_destructive\""
Enter
Sleep 3s
